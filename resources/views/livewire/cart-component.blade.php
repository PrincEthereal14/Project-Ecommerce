                ...
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive">
                            {{-- has succes dari shop component --}}
                                                ...
                                                <td class="text-center" data-title="Stock">
                                                    <div class="detail-qty border radius  m-auto">
                                                        ...
                                                        <a href="#" class="qty-down"><i
                                                                class="fi-rs-angle-small-down" wire:click.prevent="decreaseQuantity('{{ $item->rowId }}')"></i></a>
                                                        {{-- qty --}}
                                                        <span class="qty-val">{{ $item->qty }}</span>
                                                        {{-- menambah qty --}}
                                                        <a href="#" class="qty-up"><i
                                                                class="fi-rs-angle-small-up"wire:click.prevent="increaseQuantity('{{ $item->rowId }}')"></i></a>
                                                    </div>
                                                </td>
                                                <td class="text-right" data-title="Cart">
                                                    {{-- kayake bawaan hardevine --}}
                                                    <span>${{ $item->subtotal }} </span>
                                                </td>
                                                <td class="action" data-title="Remove"><a href="#"
                                                        class="text-muted" wire:click.prevent="destroy('{{ $item->rowId }}')"><i class="fi-rs-trash"></i></a></td>
                                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="6" class="text-end">
                                                <a href="#" class="text-muted"
                                                    wire:click.prevent="clearAll()"> <i
                                                        class="fi-rs-cross-small" wire:click.prevent="clearAll()"></i>
                                                    Clear
                                                    Cart</a>
                                            </td>
                                        </tr>
                                    @else
                                        {{-- jika tidak ada barang dalam kerangjang --}}
