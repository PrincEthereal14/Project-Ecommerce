...
<div class="header-action-icon-2">
    ...
    <div class="cart-dropdown-wrap cart-dropdown-hm2">
        <ul>
            {{-- item2 yang dimasukan dalam kranjang --}}
            ...
            <li>
                ...
                <div class="shopping-cart-title">
                    {{-- pake fungsi substr/ memotong(mengambil sebagian string) --}}
                    {{-- $kalimat = "Belajar PHP di Duniailkom";
                        $sub_kalimat = substr($kalimat,3);
                        echo $sub_kalimat;
                        // Outputnya adalah ajar PHP di Duniailkom --}}
                        {{-- substr($string yang akan diambil,mulai dari index ke-,jumlah index) --}}
