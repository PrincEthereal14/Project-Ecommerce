...
<head>
    ...
    {{-- cara agar userdashboard tetep pake css pake harus tetep ditembak --}}
...
<body>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            ...
                            @auth
                                {{-- jika sudah menjalani auth yang tertampil adalah --}}
                                <ul>
                                    <li><i class="fi-rs-user"></i>{{ Auth::user()->name }} /
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            {{-- event.preventDefault()=Cegah tautan membuka URL: --}}
                                            <a href="{{ route('logout') }}"
                                ...
                                {{-- jika belum menjalani auth yang tertampil adalah --}}
                            @else
                                <ul>
                                    <li><i class="fi-rs-key"></i><a href="{{ url('login') }}">Log In </a> / <a
                            ...
                            <nav>
                                <ul>
                                    ...
                                    <li><a href="#">My Account<i class="fi-rs-angle-down"></i></a>
                                        {{-- artinya ada campur tangan sistem authentifikasi --}}
                                        @auth
    ...
    {{-- komponen2 seperti cart shop dsb jadi $slot disini  --}}
    {{ $slot }}
    {{-- komponen2 seperti cart shop dsb jadi $slot disini  --}}
    <footer class="main">
